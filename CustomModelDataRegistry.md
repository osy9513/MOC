...
| **jumptaengi** (1) | 분홍색 염료 (`pink_dye`) | 점탱이 (`Jumptaengi.java`) | `models/item/jumptaengi.json` |
| **jihyun** (1) | 하얀색 양털 (`white_wool`) | 지현 (`Jihyun.java`) | `models/item/jihyun.json` |
| **tungtung_bat** (1) | 막대기 (`stick`) | 퉁퉁퉁사후 (`TungTungTungSahur.java`) | `models/item/tungtung_bat.json` |
| **frieren** (2) | 막대기 (`stick`) | 프리렌 (`Frieren.java`) | `models/item/frieren.json` |
| **ddangkong1** (2) | 폭죽 탄약 (`firework_star`) | 땅콩 (`Ddangkong.java`) | `models/item/ddangkong1.json` |
| **ddangkong2** (1) | TNT (`tnt`) | 땅콩 (`Ddangkong.java`) | `models/item/ddangkong2.json` |
...
| **health_potion** (2) | 물약 (`potion`) | 기본지급재생포션 | `models/item/health_potion.json` |
