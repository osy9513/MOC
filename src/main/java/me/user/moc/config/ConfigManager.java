...
public class ConfigManager {
    ...
    public int map_size = 100; // 전장(경기장)의 크기
    ...
    public boolean auto_restart = false; // [추가] 게임 종료 시 30초 후 자동 재시작 여부
    public boolean auto_stop = false; // [추가] 3연속 혼자 남을 시 자동 게임 종료 여부
    ...
    public void load(FileConfiguration config) {
        ...
        map_size = config.getInt("map_size", 100);
        ...
        auto_restart = config.getBoolean("auto_restart", false); // [추가] 자동 재시작 여부
        auto_stop = config.getBoolean("auto_stop", false); // [추가] 3연속 혼자 남을 시 게임 자동 종료 여부
    ...
    public void save() {
        ...
        config.set("auto_restart", auto_restart); // [추가] 자동 재시작 저장
        config.set("auto_stop", auto_stop); // [추가] 3연속 1인 자동 종료 저장
